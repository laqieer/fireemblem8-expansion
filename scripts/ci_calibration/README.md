# Disposable issue-180 CI baseline 7
...
`calibration/issue-180-ci-baseline-7` by the repository owner. The workflow
...
Baseline 7 pins actual CURRENT `d026` / BASE `798` below and uses the delivered
...
`d02614cb800736f78b513332a03f793631b6d369`, with full Git history and recursively
...
actionlint .github/workflows/issue180-ci-baseline-7.yml
```
...
```bash
git push origin HEAD:refs/heads/calibration/issue-180-ci-baseline-7
```
