...
class IndexedLocaleOverrideTests(unittest.TestCase):
    ...
    def test_catalog_is_hash_pinned_and_has_provenance(self):
        ...
        self.assertEqual(catalog.entry_count, 226)
        ...
        self.assertEqual(len(catalog.sources["fe8j_indexed"].entries), 70)
        self.assertEqual(len(catalog.sources["fe8cn_source"].entries), 156)
