...
from scripts.workflow_pilot import agent_handoff, candidate_evidence, reporter
...
class DevelopmentWorkflowSkillTests(unittest.TestCase):
    ...
    def test_bounded_exact_sha_agent_handoff_is_indexed(self):
        ...
        for requirement in (
            ...
            "signed publication-plan identity",
            "never emits an endpoint, refspec, credential, or force command",
