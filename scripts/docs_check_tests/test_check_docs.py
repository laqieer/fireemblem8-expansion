                ...
                "cases": {
                    "TC-WORKFLOW-PUBLISHER-PHASE-001": {
                        ...
                        "commands": {
                            ...
                            "test_publisher_phase_uses_shared_execution_authority",
                            "python3 -m unittest -v "
                            "tests.workflows.test_patch_release_workflow."
                            "PatchReleaseWorkflowTests."
                            "test_writable_mount_audit_rejects_unexpected_rw_targets_and_preserves_allowed_private_mounts "
                            "tests.workflows.test_patch_release_workflow."
                            "PatchReleaseWorkflowTests."
                            "test_child_launcher_closes_bash_memfd_pipe_and_socket_fds "
                            "tests.workflows.test_patch_release_workflow."
                            "PatchReleaseWorkflowTests."
                            "test_supervisor_launcher_authenticates_session_before_namespace_and_leaves_no_orphan "
                            "tests.workflows.test_patch_release_workflow."
                            "PatchReleaseWorkflowTests."
                            "test_stopped_supervisor_dies_with_parent_before_resume_without_orphan "
                            "tests.workflows.test_patch_release_workflow."
                            "PatchReleaseWorkflowTests."
                            "test_cleanup_reauthenticates_and_terminates_owned_supervisor",
                        },
                    },
