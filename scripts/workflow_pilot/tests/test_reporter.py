...
class RepositoryAuthorityTests(unittest.TestCase):
    ...
    def test_repository_authority_uses_minimal_offline_git_environment(self):
        ...
        for setting in ("--no-pager", "core.fsmonitor=false", "core.hooksPath=/dev/null", "core.pager=cat", "credential.helper=", "core.sshCommand=/usr/bin/ssh", "protocol.ext.allow=never"):
