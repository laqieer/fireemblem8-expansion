...
class BluePhaseDelegateMenuTests(unittest.TestCase):
    ...
    def generated_header(directory):
        ...
        path.write_text(
            ...
            "#define EXP_MSG_AUTOPLAY_CHARGE_LABEL 63u\n"
            "#define EXP_MSG_AUTOPLAY_CHARGE_HELP 64u\n",
            encoding="utf-8",
        )
        return path
...
class BluePhaseDelegateLocalizationTests(unittest.TestCase):
    def test_stable_ids_and_every_authored_locale(self):
        ...
        self.assertEqual(entries["autoplay.charge.label"]["id"], 63)
        self.assertEqual(entries["autoplay.charge.help"]["id"], 64)
