...
u8 ALIGNED(2) gPal_SaveSlotHardSelectedBlendB[] = INCBIN_U8("graphics/misc/gUnknown_08A07BEA.4bpp");
u16 ALIGNED(2) gPal_SaveSlotHardUnselectedBlendB[] = { 0x39F3, 0x0443, 0x3E11, 0x52D7, 0x4A98, 0x290A, 0x5F3D, 0x520E, 0x677D, 0x296A, 0x31AC, 0x39EE, 0x4230, 0x4A52, 0x5294, 0x5AD6, 0x6318, 0x2109, 0x3E11, 0x52D7, 0x5AD6, 0x212A, 0x6F7B, 0x520E, 0x52D8, 0x0CA3, 0x10C4, 0x1906, 0x2148, 0x296A, 0x31AC, 0x39CE, 0x4210, 0x0443, 0x3E11, 0x52D7, 0x5AD6, 0x212A, 0x6F7B };
u16 ALIGNED(2) Pal_ChapterTitleMain[] = INCBIN_U16("graphics/misc/gPal_08A07C58.gbapal");
