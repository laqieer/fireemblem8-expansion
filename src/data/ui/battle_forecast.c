...
u16 gTSA_BattleForecastExtended[] = INCBIN_U16("graphics/misc/gTSA_BattleForecastExtended.tsa.bin");

u16 gBattleForecast_x2x4Gfx[] = INCBIN_U16("graphics/misc/gBattleForecast_x2x4Gfx.4bpp.lz");
