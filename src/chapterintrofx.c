...
struct ProcCmd CONST_DATA gProcScr_ChapterIntro[] =
{
    ...
    PROC_CALL(ChapterIntro_SetBG_0),
    ...
    PROC_CALL(ChapterIntro_1),
    PROC_REPEAT(ChapterIntro_2),
...
struct ProcCmd CONST_DATA sProcScr_Chapterintrofx_0[] =
{
...
//! FE8U = 0x0802009C
void ChapterIntro_SetBG_0(void)
{
...
void ChapterIntro_DrawChapterTitle(void)
{
    ...
    /*
     * The localized path replaces the complete BG0 tilemap; the fallback
     * path draws the vanilla title strip at its centered location.
     */
...
//! FE8U = 0x08021188
void ChapterIntro_4(struct ChapterIntroFxProc * proc)
{
    if ((GetGameClock() & 1) == 0)
    {
        CALLARM_ColorFadeTick();
