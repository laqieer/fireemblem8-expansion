...
enum
{
    ...
    EXPANSION_AUTOPLAY_PLANNER_PAYLOAD_WORD_COUNT = 231,
    EXPANSION_AUTOPLAY_PLANNER_PAGE_DIGEST_WORD = 230,
    EXPANSION_AUTOPLAY_PLANNER_MAP_CELL_CAPACITY = 64 * 64,
    EXPANSION_AUTOPLAY_PLANNER_SEMANTIC_FIELD_CAPACITY = 8,
    EXPANSION_AUTOPLAY_PLANNER_MAP_RECORD_CAPACITY = 230,
...
union ExpansionAutoplayPlannerPayloadV2
{
    ...
    u32 words[EXPANSION_AUTOPLAY_PLANNER_PAYLOAD_WORD_COUNT];
};
