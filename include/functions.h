...
// ??? IsChar0DeadAsNonPlayerUnit(???);
// ??? IsChar0DeadAsNonPlayerUnit_02(???);
// ??? IsChar0DeadAsNonPlayerUnit_03(???);
// ??? IsChar0DeadAsNonPlayerUnit_2(???);
// ??? IsChar0DeadAsNonPlayerUnit_02_2(???);
// ??? IsChar0DeadAsNonPlayerUnit_03_2(???);
// ??? IsChar0DeadAsNonPlayerUnit_04(???);
// ??? IsChar0DeadAsNonPlayerUnit_05(???);
// ??? IsChar0DeadAsNonPlayerUnit_06(???);
// ??? IsChar0DeadAsNonPlayerUnit_07(???);
// ??? IsChar0DeadAsNonPlayerUnit_08(???);
...
// ??? Uidebug_IsDeadEnemyCountAtLeast50(???);
// ??? Uidebug_ConstFalse(???);
