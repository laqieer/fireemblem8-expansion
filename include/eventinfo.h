...
bool Eventinfo_CondFalse_0(void);
bool Eventinfo_CondFalse_1(void);
bool Eventinfo_CondFalse_2(void);
bool Eventinfo_CondFalse_3(void);
bool Eventinfo_CondFalse_4(void);
bool CheckWin(void);
