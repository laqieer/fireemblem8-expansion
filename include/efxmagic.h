...
extern u16 * gEfxmagicFlux_0[];
extern u16 * gEfxmagicFlux_1[];
...
// ??? efxDarkGradoPalFlash_Init(???);
// ??? efxDarkGradoPalFlash_Loop(???);
...
// ??? EfxmagicShadowshot_FadeToBlack_Init(???);
...
// ??? EfxmagicDemonsurgeFadeBlack_Init(???);
// ??? EfxmagicDemonsurgeFadeBlack_Loop_FadeOut(???);
// ??? EfxmagicDemonsurgeFadeBlack_Loop_HoldBlack(???);
...
// ??? EfxmagicDemonsurgeFlash_Init(???);
// ??? EfxmagicDemonsurgeFlash_Loop_White(???);
// ??? EfxmagicDemonsurgeFlash_Loop_HoldBlack(???);
// ??? EfxmagicDemonsurgeFlash_Loop_FadeIn(???);
void StartEfxmagicDemonsurgeFlashWhite(void);
// ??? EfxmagicDemonsurgeFlash_Loop_FadeOut(???);
