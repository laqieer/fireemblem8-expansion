...
// ??? EventText_StartTalkMsg(???);
// ??? EventText_StartCgTextMsg(???);
// ??? EventText_StartBoxDialogueMsg(???);
...
void EndEventFaces(struct EventEngineProc*);
// ??? _WhileFace6CExists(???);
...
// ??? ConvoBackgroundFade_Init(???);
// ??? ConvoBackgroundFade_CopyBg3ToBg2(???);
// ??? ConvoBackgroundFade_CopyBg2ToBg3(???);
// ??? ConvoBackgroundFade_LoadBg2(???);
// ??? ConvoBackgroundFade_LoadBg3(???);
// ??? ConvoBackgroundFade_RestoreMap(???);
// ??? ConvoBackgroundFade_Loop(???);
// ??? ConvoBackgroundFade_End(???);
