...
- docs/test-cases/debugtools.md | laqieer | current | Typed State/Engine diagnostics and cursor-selected bounded unit inspector/editor procedures, negatives, save neutrality, and automation (issues #127 and #125)
