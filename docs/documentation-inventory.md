...
- docs/validation-ownership-probe.md | laqieer | current | Confined GNU Make/generated-source ownership probe and aggregate resource authority (issue #206)
...
- docs/test-cases/workflow-governance.md | laqieer | current | Indexed trusted-push, CI-wait, manual-handoff, stacked-CI, pilot-baseline, metadata-edit, and ownership-probe procedures (issues #93/#169/#171/#176/#177/#206)
