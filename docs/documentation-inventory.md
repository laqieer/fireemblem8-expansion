...
- docs/autoplay.md | laqieer | current | Transient typed blue controller/telemetry, bounded terminal outcomes, and accelerated-fidelity profile (issues #85/#86/#88)
...
- docs/test-cases/autoplay.md | laqieer | current | Blue computer-phase, bounded termination, and accelerated-fidelity procedures (issues #85/#86/#88)
