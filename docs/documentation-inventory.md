...
- docs/authenticated-git-broker.md | laqieer | current | Protected external Git publication, signed exact plans, canonical timestamps, deployment and acceptance boundaries (issue #205)
