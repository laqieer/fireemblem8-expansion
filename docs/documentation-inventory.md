...
- docs/workflow-pilot.md | laqieer | current | Frozen workflow-efficiency baseline, decision schema, formulas, and artifact lifecycle (issue #176)
...
- docs/test-cases/workflow-governance.md | laqieer | current | Indexed trusted-push, CI-wait, manual-handoff, stacked-CI, workflow-pilot, and validation-ownership procedures (issues #93/#169/#171/#176/#180)
