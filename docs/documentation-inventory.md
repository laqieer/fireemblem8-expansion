...
- docs/git-publication-broker.md | laqieer | current | Authenticated external one-shot Git authority and anchor publication broker deployment contract (issue #205)
