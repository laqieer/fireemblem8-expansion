...
- docs/workflow-pilot.md | laqieer | current | Frozen workflow-efficiency baseline and executable sibling-family review convergence (issues #176 and #179)
...
- docs/test-cases/workflow-governance.md | laqieer | current | Indexed trusted-push, CI-wait, manual-handoff, stacked-CI, and workflow-pilot baseline procedures (issues #93/#169/#171/#176)
