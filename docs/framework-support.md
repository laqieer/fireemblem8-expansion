...
- **#6 starter features:**
  ...
  the content profile rides gates 22-23 of the current
...
- **#10 typed IDs:** DEFAULT committed and ACTIVE build-local contracts,
  ...
  debug/release runtime commands are gates 22-23 of the current-master
  30-gate upstream-port verifier; gate 24 builds the all-locales/all-features
