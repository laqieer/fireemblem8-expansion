...
permits handoff only when the members are the wrapper PID and its own transient
checker PID. The checker exits before export; host-side kill/removal still uses
the actual cgroup path.
