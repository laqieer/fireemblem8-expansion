...
| [`ownership-probe-dependencies.md`](ownership-probe-dependencies.md) | Current | Confined dependency-only C preprocessing, execution-bound header provenance and real Make publication (issue #228) |
