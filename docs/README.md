...
| Reproduce the workflow baseline or validate an exact-SHA agent handoff | [`workflow-pilot.md`](workflow-pilot.md) |
...
| [`workflow-pilot.md`](workflow-pilot.md) | Current | Frozen workflow baseline and bounded exact-SHA agent handoffs (issues #176 and #178) |
