...
| Reproduce the workflow-efficiency pilot baseline and decision contract | [`workflow-pilot.md`](workflow-pilot.md) |
...
| [`workflow-pilot.md`](workflow-pilot.md) | Current | Frozen workflow-efficiency baseline, formulas, decision schema, and artifact lifecycle (issue #176) |
...
| [`test-cases/workflow-governance.md`](test-cases/workflow-governance.md) | Current | Trusted-push, centralized CI-wait, and actionable manual-testing handoff procedures (issues #93 and #169) |
