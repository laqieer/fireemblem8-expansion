...
| [`workflow-pilot.md`](workflow-pilot.md) | Current | Frozen workflow-efficiency baseline plus executable sibling-family review convergence (issues #176 and #179) |
...
| [`test-cases/workflow-governance.md`](test-cases/workflow-governance.md) | Current | Trusted delivery, workflow-pilot, manual handoff, and sibling-family review procedures |
