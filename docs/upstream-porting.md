...
25. `make -f scripts/validation_ownership/foundation.mk ownership-probe-test`
...
26. `make -f cjk_fonts.mk cjk-fonts-check cjk-fonts-test`
27. `python3 -m unittest discover -s scripts/texttools/tests -p 'test_multilang_codec*.py' -v`
...
dependency/tool installation. It is additional to all 31 mirrored verifier
